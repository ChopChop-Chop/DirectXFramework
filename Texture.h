...
D3DXIMAGE_INFO CTexture::getImgInfo()
{
	return m_ImgInfo;
}

void CTexture::setTexture(LPDIRECT3DTEXTURE9 a_pTexture)
{
	m_pTexture = a_pTexture;
}
void CTexture::setFileName(const char* a_sFileName)
{
	m_sFileName = new char(sizeof(a_sFileName));

	strcpy(m_sFileName, a_sFileName);
}
void CTexture::setRect(RECT a_rRect)
{
	m_rRect = a_rRect;
}
void CTexture::setImgInfo(D3DXIMAGE_INFO a_ImgInfo)
{
